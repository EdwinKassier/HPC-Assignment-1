...
#SBATCH --mail-user=kssrub001@myuct.ac.za
...
mkdir Output_Tests
echo "SBATCH --nodes=3 --ntasks=3" > Output_Tests/descr.text
make
export OMP_DYNAMIC=TRUE
#make run1 > Output_Tests/Output1.txt
make run4 > Output_Tests/Output4.txt
#make run4 > Output_Tests/Output3.txt
